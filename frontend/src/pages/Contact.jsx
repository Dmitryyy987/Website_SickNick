...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        alert(
          "Failed to submit: " +
            (data?.errors?.[0]?.msg || data?.error || "Unknown error")
        );
      } else {
  ...
  return (
    <section
      id="contact"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 border-b border-slate-800/50 pt-8 md:pt-12 lg:pt-16"
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8 py-20 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-slate-400 leading-relaxed">
                ...
                experiences? Let's discuss your project and create something
                extraordinary.
              </p>
            </div>
          ...
          <div
            ref={formRef}
            className="bg-slate-900/50 backdrop-blur-sm border border-slate-800/50 rounded-2xl p-8 lg:p-10 shadow-2xl shadow-blue-500/10"
          >
